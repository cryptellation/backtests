...
// Runner returns a container running the backtests service built from the official Dockerfile,
...
func Runner(
	...
	container = container.WithEnvVariable("SQL_DSN",
		"host=postgres user=cryptellation password=cryptellation dbname=backtests sslmode=disable")

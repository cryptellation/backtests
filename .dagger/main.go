// A generated module for backtests functions
//
...
const (
	dockerImageName = "ghcr.io/cryptellation/backtests"
)
...
func (ci *Backtests) LintDagger(sourceDir *dagger.Directory) *dagger.Container {
	c := dag.Container().
		From("golangci/golangci-lint:v1.62.0").
		WithMountedCache("/root/.cache/golangci-lint", dag.CacheVolume("golangci-lint"))
...
func (ci *Backtests) withGoCodeAndCacheAsWorkDirectory(
	...
	containerPath := "/go/src/github.com/cryptellation/backtests"
	return c.
		// Add Go caches
